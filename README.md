...
|  | [2. Minor tweaks](#2-minor-tweaks) | Disable reserved bandwidth, bufferless tracking, Drag Tray, and enable `Win + V`/`;`/`.`. |
...
- update BIOS by visiting your PC manufacturer's website and update drivers via Windows Update, your PC manufacturer's website, or third-party tools like [Snappy Driver Installer](https://sdi-tool.org/download/ "Glenn Delahoy");
...
- `Win + R → services.msc`
  ...
  - AVCTP service `(disable it if you don't use wireless technology like Bluetooth)`
...
### 4. Settings:
  - **Activate Windows (Administrator PowerShell)**: `irm https://get.activated.win | iex` or `irm https://massgrave.dev/get | iex`
  - `Win + I`  
	- System
	- Bluetooth & devices
	- Network & internet
