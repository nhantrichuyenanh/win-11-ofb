...
- Main & Additional Browser: for more information please check [VI.](#vi-wrapping-things-up)
	...
	- Firefox fork: [Floorp](floorp.app/en-US/download "Floorp Projects") / [Librewolf](https://librewolf.net/installation/windows) / [Zen Browser](https://zen-browser.app/download "Zen Browser Team") / ...
